...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            * { box-sizing: border-box; }
            ...
            .message, .error { margin: 10px 0; padding: 10px 12px; border-radius: 10px; font-size: 13px; text-align: center; word-break: break-all; }
    ...
    <body>
        <div class="card">
            ...
            <% if (resetLink != null) { %>
            <div class="message">
                Liên kết đặt lại mật khẩu (hiệu lực 30 phút):<br/>
            ...
            <form method="post" action="<%=request.getContextPath()%>/forgot-password">
                ...
                <button class="btn-primary" type="submit">Gửi liên kết đặt lại</button>
            </form>
