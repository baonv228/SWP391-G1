...
<head>
    ...
    <title>${not empty pageTitle ? pageTitle : 'FPT University Learning Materials'}</title>
    <meta name="description" content="${not empty pageDescription ? pageDescription : 'FPT University Learning Materials - Curriculum, Syllabus and Subject management system.'}"/>
