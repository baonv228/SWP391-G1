...
<html lang="vi">
    <head>
        ...
        <title>Training Program Detail</title>
    ...
    <body>
        <main class="detail-page">
            ...
            <section class="detail-toolbar">
                <div>
                    <h2>Training Program Detail</h2>
                    <p><%= programName.isBlank() ? "Program overview" : programName %></p>
                </div>
            ...
            <section class="program-card" aria-label="Training program information">
                <dl>
                    <div>
                        <dt>Tên ngành</dt>
                        <dd><%= majorName %></dd>
            ...
            <section class="curriculum-section" aria-label="Curriculum list">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="empty" colspan="5">Chưa có curriculum cho training program này.</td>
                        </tr>
                        <% } else {
                            int index = 1;
