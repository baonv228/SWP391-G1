...
<html lang="vi">
    <head>
        ...
        <link rel="stylesheet" href="<%=request.getContextPath()%>/css/TraningDepartment.css?v=2" />
...
<main class="page">
    ...
    <section class="content">
        ...
        <nav class="module-grid" aria-label="Training Department dashboard">
            ...
            <%-- NEW: Assign Teacher by Major --%>
            <a class="module-card" href="<%=request.getContextPath()%>/assign-teacher">
                <span class="module-icon">
                    <svg viewBox="0 0 24 24" aria-hidden="true">
                ...
                <span class="module-title">Assign Teacher</span>
            </a>
        </nav>
    </section>
