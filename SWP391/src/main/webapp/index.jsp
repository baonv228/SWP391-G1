        ...
        * {
        ...
        body {
            ...
            background:
                ...
                radial-gradient(circle at 10% 12%, rgba(243, 112, 33, 0.12), transparent 28%),
                radial-gradient(circle at 88% 82%, rgba(243, 112, 33, 0.08), transparent 32%);
        }
        ...
        .brand-mark {
            ...
            box-shadow: 0 0 0 4px rgba(243, 112, 33, 0.14);
        }
        ...
        .visual {
            ...
            overflow: hidden;
            background:
                linear-gradient(160deg, rgba(243, 112, 33, 0.16), rgba(255, 255, 255, 0.3)),
                repeating-linear-gradient(90deg, rgba(243, 112, 33, 0.16) 0 2px, transparent 2px 48px),
                repeating-linear-gradient(0deg, rgba(243, 112, 33, 0.1) 0 2px, transparent 2px 48px),
                #fff8f3;
            box-shadow: inset 0 0 0 1px rgba(243, 112, 33, 0.16), 0 24px 70px rgba(43, 43, 43, 0.12);
        }
...
<main class="page">
    <header class="topbar">
        <div class="brand"><span class="brand-mark"></span>TPMS</div>
